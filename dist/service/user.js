        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (existingVolunteer) {
                    return (0, common_1.formatData)({ message: "User already exists." });
                }
                let newVolunteer = user_1.default.addUser({
                    name,
                    address,
                    city,
                    state,
                ...
                return (0, common_1.formatData)({ newVolunteer, message: "User added to DB." });
            }
            catch (error) {
                console.error(error);
